...
func SetupRoutes(app *fiber.App, db *pgxpool.Pool, log *logrus.Logger) {
	...
	tenantGroup.Get("/donation-channels", engagementController.ListStaticPaymentMethods)
	tenantGroup.Post("/donation-channels", engagementController.CreateStaticPaymentMethod)
	tenantGroup.Get("/donation-channels/:id", engagementController.GetStaticPaymentMethod)
	tenantGroup.Put("/donation-channels/:id", engagementController.UpdateStaticPaymentMethod)
	tenantGroup.Delete("/donation-channels/:id", engagementController.DeleteStaticPaymentMethod)
